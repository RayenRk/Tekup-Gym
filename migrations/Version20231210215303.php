 ...
 */
final class Version20231210215303 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE messagerie (id INT AUTO_INCREMENT NOT NULL, coach_id INT DEFAULT NULL, user_id INT DEFAULT NULL, contenu VARCHAR(255) DEFAULT NULL, date_message DATE DEFAULT NULL, INDEX IDX_14E8F60C3C105691 (coach_id), INDEX IDX_14E8F60CA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
